export const persistentStorage = {
     ...
     * The callback will also be run if the localStorage cache has expired.  You can use {@link persistentStorage#setItem} in the callback to save the results from the callback back to localStorage.
     *
